...
NSGminer specific configuration options:
        --disable-neoscrypt     Build without support for NeoScrypt (default enabled)
        --enable-scrypt         Build with support for Scrypt (default disabled)
        --enable-sha256d        Build with support for SHA-256d (default disabled)
        ...
        --disable-nvml          Build with no NVML GPU monitoring (default enabled)
...
Usage: nsgminer [-atDdGCEgIKklmpxPQqsTouvwOchnV]
Options for both config file and command line:
--neoscrypt         Use the NeoScrypt algorithm for mining
--scrypt            Use the Scrypt algorithm for mining
--lookup-gap <arg>  Specify GPU look-up gap (Scrypt only), comma separated
--shaders <arg>     Specify GPU shaders per card (Scrypt only), comma separated
--thread-concurrency <arg> Specify GPU thread concurrency per card (Scrypt only), comma separated
--sha256d           Use the SHA-256d algorithm for mining
--algo|-a <arg>     Specify sha256 implementation for CPU mining:
	...
	sse2_64		SSE2 64 bit implementation for x86_64 machines (default: sse2_64)
--api-allow <arg>   Allow API access only to the given list of [G:]IP[/Prefix] addresses[/subnets]
--api-description <arg> Description placed in the API status header, default: miner version
...
--benchmark         Run the miner in benchmark mode - produces no shares
...
--cpu-threads|-t <arg> Number of miner CPU threads (default: -1)
...
--gpu-map <arg>     Map OpenCL to ADL or NVML device order manually, paired CSV (e.g. 1:0,2:1 maps OpenCL 1 to ADL 0, 2 to 1)
...
--intensity|-I <arg> Intensity of GPU scanning (d or fixed number within range; default: d to maintain desktop interactivity)
--kernel-path|-K <arg> Specify a path to where bitstream and kernel files are (default: "/usr/local/bin")
--kernel|-k <arg>   Specify an OpenCL kernel to use, one value or comma separated
...
--no-adl            Disable the AMD Display Library used for monitoring and setting GPU parameters
...
--pass|-p <arg>     Password for a JSON-RPC server
...
--url|-o <arg>      URL for a JSON-RPC server
--user|-u <arg>     Username for a JSON-RPC server
--vectors|-v <arg>  Override detected optimal vector (1, 2 or 4) - one value or comma separated list
--verbose           Log verbose output to stderr as well as status output
--worksize|-w <arg> Override detected optimal worksize - one value or comma separated list
--userpass|-O <arg> Username:Password pair for a JSON-RPC server
